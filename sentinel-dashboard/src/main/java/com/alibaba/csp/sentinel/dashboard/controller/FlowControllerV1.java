...
public class FlowControllerV1 {
    ...
    private <R> Result<R> checkEntityInternal(FlowRuleEntity entity) {
        ...
        if (entity.getLimitQps() == null || entity.getLimitQps() < 0) {
            return Result.ofFail(-1, "LimitQps count should be at lease zero");
        }
        if (entity.getExpQps() == null || entity.getExpQps() < 0) {
            return Result.ofFail(-1, "ExpQps count should be at lease zero");
        }
    ...
    public Result<FlowRuleEntity> updateIfNotNull(HttpServletRequest request, Long id, String app,
                                                  ...
                                                  Integer maxQueueingTimeMs, Integer limitQps, Integer expQps) {
        AuthUser authUser = authService.getAuthUser(request);
        ...
        if (limitQps != null) {
            entity.setLimitQps(limitQps);
        }
        if (expQps != null) {
            entity.setExpQps(expQps);
        }
        if (count != null) {
