...
public class FlowRuleEntity implements RuleEntity {
    ...
    public static FlowRuleEntity fromFlowRule(String app, String ip, Integer port, FlowRule rule) {
        ...
        int couutQps = new Double(rule.getCount()).intValue();
        entity.setLimitQps(rule.getLimitQps()==0?couutQps:rule.getLimitQps());
        entity.setExpQps(rule.getExpQps()==0?couutQps:rule.getExpQps());
        return entity;
    }
    ...
    public Integer getExpQps() {
        return expQps;
    }

    public void setExpQps(Integer expQps) {
        this.expQps = expQps;
    }
    ...
    public FlowRule toRule() {
        ...
        flowRule.setExpQps(this.expQps);
        flowRule.setLimitQps(this.limitQps);
        return flowRule;
    }
